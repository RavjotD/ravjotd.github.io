...
const items = [
  ...
  },
  {
    ...
    title: "Business Site",
    desc: "A business website built with a CMS, providing security services to enhance its online presence and increase its client base.",
    img: "/Screenshot.png",
  ...
  },
  {
    ...
    title: "Weather App",
    desc: "Weather app providing real-time data metrics of wind, humidity, and temperature for cities globally.",
    img: "/weather.png",
  ...
  },
  {
    ...
    desc: "Raspberry Pi project utilizing detection methods for human-face and object avoidance, along with red ball tracking.",
    img: "/face.png",
  ...
  return (
    <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
      ...
      <div className="h-[600vh] relative p-0" ref={ref}>
        <div className="w-screen h-[calc(100vh-6rem)] flex items-center justify-center text-4xl lg:text-8xl text-center p-2 text-black text-opacity-70 font-sans font-bold">
          My Work
        </div>
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden p-4">
          ...
          <motion.div style={{ x }} className="flex">
            ...
            {items.map((item) => (
              ...
              <div className={`h-screen w-screen flex items-center justify-center px-6 lg:px-8 overflow-clip bg-gradient-to-tr ${item.color}`} key={item.id}>
                <div className={`flex flex-col gap-2 border-4 ${item.bgcolor} ${item.bcolor} rounded-lg text-white`}>
                  ...
                  <Link href={item.link}
                     aria-label={`View demo of ${item.title}`} className="flex justify-end p-4">
